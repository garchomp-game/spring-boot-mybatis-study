...
badd +1 src/main/java/dev/itboot/mb/repository/TeacherMapper.java
badd +28 src/main/java/dev/itboot/mb/service/TeacherService.java
...
badd +157 ~/.config/nvim/lua/custom/plugins/init.lua
...
badd +11 src/main/resources/dev/itboot/mb/repository/TeacherMapper.xml
...
badd +32 build.gradle
badd +1 ~/workspace/myapp
badd +1 src/main/resources/templates/list.html
badd +17 src/main/resources/templates/fragments/pagination.html
argglobal
%argdel
...
wincmd w
argglobal
if bufexists(fnamemodify("src/main/resources/templates/fragments/pagination.html", ":p")) | buffer src/main/resources/templates/fragments/pagination.html | else | edit src/main/resources/templates/fragments/pagination.html | endif
if &buftype ==# 'terminal'
  silent file src/main/resources/templates/fragments/pagination.html
endif
balt src/main/java/dev/itboot/mb/repository/TeacherMapper.java
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
